...
public abstract class BottomBasesOsDialog <T extends BottomBasesOsDialog<T>> extends BottomTopBasesOsDialog {
    public BottomBasesOsDialog(Context context, View animateView) {
        super(context);
    ...
    public BottomBasesOsDialog(Context context) {
        this(context, null);
    }
