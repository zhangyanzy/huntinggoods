...
public abstract class BottomTopBasesOsDialog<T extends BottomTopBasesOsDialog<T>> extends BasesOsDialog {
    ...
    public BottomTopBasesOsDialog(Context context) {
        super(context);
    }
    ...
    protected void showWithAnim() {
        if (innerShowAnim != null) {
            ...
            innerShowAnim.setAnimationListener(new Animation.AnimationListener() {
                @Override
    ...
    protected void dismissWithAnim() {
        if (innerDismissAnim != null) {
            ...
            innerDismissAnim.setAnimationListener(new Animation.AnimationListener() {
                @Override
                public void onAnimationStart(Animation animation) {
