...
import com.jinxun.hunting_goods.weight.LoadMoreView;
    ...
    private void bindViewClickListener(final ClickableViewHolder viewHolder){
        ...
        if(onItemClickListener != null){
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onItemClickListener.onItemClick(view, viewHolder.getLayoutPosition() - getHeaderLayoutCount(),viewHolder.getAdapterPosition());
                }
            });
